                ...
                { this.state.showMessage && this.state.METHOD_OF_PAYMENT==="paypal" && (<div style={{paddingTop:"20px", display:"absolute"}}>
                    <PayPalButton style={{topPadding:"20px"}}
                        ...
                        onSuccess={(details, data) => {
                            ...
                            }).then(window.location.replace("/payment-complete"))
                            //.then(window.location.replace("/"));
                            }}

                        options={{
                            clientId: "ATngQi4M-Ic8pEV7goJUWvkyyVJGvsFB0Jsp_1qd1uQpqgzlsU9S8BwNVM8tQcGkVmP__Efitt0anJWb"  //"PRODUCTION_CLIENT_ID"
                        }}
                    />    
                </div>) }      
